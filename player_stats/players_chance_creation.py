...
with sync_playwright() as p:
    ...
    page.locator('text=Chance Creation').click()
    ...
    with open(r"D:/Next Academy/My Own Project/football/player_stats/players_chance_creation_25-26.csv", "w+", encoding='utf-8') as f:
        f.write("player_name,matches_played,Mins,Total Assist,OP Assist,Total Chances Created,OP Chances Created,Total XA,OP XA,Player Id,Club Name\n".lower().replace(' ', '_'))
