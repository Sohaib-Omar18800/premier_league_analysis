...
with sync_playwright() as p:
    ...
    with open(r"D:/Next Academy/My Own Project/football/player_stats/players_defending_overall_25-26.csv", "w+", encoding='utf-8') as f:
        f.write('player_name,matches_played,mins,tackles,ints,pos_won,blocks,clearances,total_ground_duel,ground_duel_won,ground_percentage,total_aerial_duel,total_aerial_won,total_aerial_percentage,player_id,club_name\n')
