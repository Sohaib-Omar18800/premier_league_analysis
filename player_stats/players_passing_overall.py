...
with open(r"D:/Next Academy/My Own Project/football/player_stats/opta_clean_data.csv", "r", encoding='utf-8') as f:
    ...
    for players in reader:
        if players['player_name'] not in player_dic:
            player_dic[players['player_name']] = players['player_id']
        else:
            continue
...
with sync_playwright() as p:
    ...
    page.get_by_role('option', name='Passing').click(timeout=100000)
    ...
    with open(r"D:/Next Academy/My Own Project/football/player_stats/players_passing_overall_25-26.csv", "w+", encoding='utf-8') as f:
        f.write("player_name,matches_played,Mins,Total Open Play Passes,Successfull Open Play Passes,Percentage Open Play Passes,In Final Third Total,In Final Third Successfull,In Final Third Percentage,Crosses Total,Crosses Successful,Crosses Percentage,Through Balls,Player Id,Club Name\n".replace(' ', '_').lower())
