...
with sync_playwright() as p:
    ...
    page.get_by_role("option", name="Pressing").click(timeout=100000)
    page.wait_for_selector('table')
    rows = page.locator("table tbody tr").all()
    with open(r"D:/Next Academy/My Own Project/football/pressing/club_pressing_25-26.csv", mode="w+") as f:
        f.write('club_name,matches_played,pressed_seqs,ppda,start_distance(M),total,shot_ending,high_turnovers_goals_ending,high_turnovers_end_in_shot_percentage,club_id\n')
        for row in rows:
